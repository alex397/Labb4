...
public class GamePanel extends JPanel implements Observer{
	...
	public void Circle(int x, int y, Color color, Graphics g) { //KAN KOMMA ATT BEHÖVA ÄNDRA STORLEKAR
		g.setColor(color);
		g.drawOval(x*UNIT_SIZE, y*UNIT_SIZE, UNIT_SIZE-2, UNIT_SIZE-2);
	}	
	public void Cross(int x, int y, Color color, Graphics g) { //KAN KOMMA ATT BEHÖVA ÄNDRA STORLEKAR
		g.setColor(color);
